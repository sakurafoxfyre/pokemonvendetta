...
void CustomTrainerPartyAssignMoveSet(struct Pokemon *mon, const struct TrainerMon *partyEntry, u16 setSelection); //the same thing as AssignMoves but using a randomly selected move set
