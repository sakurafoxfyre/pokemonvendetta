...
extern const u32 gBattleAnimBgImage_AromaticTerrain[];
extern const u16 gBattleAnimBgPalette_AromaticTerrain[];
extern const u32 gBattleAnimBgTilemap_AromaticTerrain[];
