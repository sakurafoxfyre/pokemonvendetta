...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_MEGA_SOL = 314,
    ABILITY_FIRE_MANE = 315,
    ABILITY_SPICY_SPRAY = 316,
    ABILITIES_COUNT_GEN9,

    // Vendetta
    //ABILITY_LIFE_VEST = ABILITIES_COUNT_GEN9,
    ABILITIES_COUNT_VENDETTA = ABILITIES_COUNT_GEN9,
    ABILITIES_COUNT = ABILITIES_COUNT_VENDETTA,
};
