...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_SWIMMER, //6
    TRAINER_CLASS_TEAM_MAGMA, //7
    TRAINER_CLASS_EXPERT, //8
    TRAINER_CLASS_BLACK_BELT, //9
    TRAINER_CLASS_HEX_MANIAC, //10
    TRAINER_CLASS_AROMA_LADY, //11
    TRAINER_CLASS_RUIN_MANIAC, //12
    TRAINER_CLASS_TUBER, //13
    TRAINER_CLASS_LADY, //14
    TRAINER_CLASS_BEAUTY, //15
    TRAINER_CLASS_RICH_BOY, //16
    TRAINER_CLASS_POKEMANIAC, //17
    TRAINER_CLASS_GUITARIST, //18
    TRAINER_CLASS_KINDLER, //19
    TRAINER_CLASS_CAMPER, //20
    TRAINER_CLASS_PICNICKER, //21
    TRAINER_CLASS_BUG_MANIAC, //22
    TRAINER_CLASS_PSYCHIC, //23
    TRAINER_CLASS_GENTLEMAN, //24
    TRAINER_CLASS_SCHOOL_KID, //25
    TRAINER_CLASS_SR_AND_JR, //26
    TRAINER_CLASS_POKEFAN, //27
    TRAINER_CLASS_YOUNGSTER, //28
    TRAINER_CLASS_FISHERMAN, //29
    TRAINER_CLASS_TRIATHLETE, //30
    TRAINER_CLASS_DRAGON_TAMER, //31
    TRAINER_CLASS_NINJA_BOY, //32
    TRAINER_CLASS_BATTLE_GIRL, //33
    TRAINER_CLASS_PARASOL_LADY, //34
    TRAINER_CLASS_TWINS, //35
    TRAINER_CLASS_SAILOR, //36
    TRAINER_CLASS_BUG_CATCHER, //37
    TRAINER_CLASS_PKMN_RANGER, //38
    TRAINER_CLASS_LASS, //39
    TRAINER_CLASS_YOUNG_COUPLE, //40
    TRAINER_CLASS_SIS_AND_BRO, //41
    TRAINER_CLASS_AETHER, //42
    //specialty trainer break
    TRAINER_CLASS_ROXANNE,
    TRAINER_CLASS_BRAWLY,
    TRAINER_CLASS_WALLY,
    TRAINER_CLASS_FLANNERY,
    TRAINER_CLASS_MAY,
    TRAINER_CLASS_TATE,
    TRAINER_CLASS_LIZA,
    TRAINER_CLASS_WALLACE,
    TRAINER_CLASS_ZINNIA,
    TRAINER_CLASS_ARCHIE,
    TRAINER_CLASS_COURTNEY,
    TRAINER_CLASS_CERISE,
    TRAINER_CLASS_AETHER_ADMIN,
    TRAINER_CLASS_AQUA_ADMIN,
    TRAINER_CLASS_MAGMA_ADMIN,
    TRAINER_CLASS_DUNCAN,
    TRAINER_CLASS_TEMPONE,
    TRAINER_CLASS_CYNTHIA,
    TRAINER_CLASS_RED,
    TRAINER_CLASS_BLUE,
    TRAINER_CLASS_SILVER,
    TRAINER_CLASS_LANCE,
    TRAINER_CLASS_CYRUS,
    TRAINER_CLASS_STEVEN,
    TRAINER_CLASS_VICTORY_ROAD,
    TRAINER_CLASS_PHOEBE,
    TRAINER_CLASS_NORMAN,
    TRAINER_CLASS_BRENDAN,
