...
static const struct PyramidTrainerEncounterMusic sTrainerClassEncounterMusic[54] =
{
    ...
    {TRAINER_CLASS_ARCHIE, TRAINER_ENCOUNTER_MUSIC_AQUA},
    ...
    {TRAINER_CLASS_COURTNEY, TRAINER_ENCOUNTER_MUSIC_MAGMA},
    ...
    {TRAINER_CLASS_STEVEN, TRAINER_ENCOUNTER_MUSIC_MALE},
