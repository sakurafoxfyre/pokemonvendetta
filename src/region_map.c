...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_HAUNTWOOD] = {MAP_GROUP(MAP_HAUNTWOOD), MAP_NUM(MAP_HAUNTWOOD), HEAL_LOCATION_NONE},
    [MAPSEC_RUSTBORO_PIER] = {MAP_GROUP(MAP_RUSTBORO_PIER), MAP_NUM(MAP_RUSTBORO_PIER), HEAL_LOCATION_NONE},
