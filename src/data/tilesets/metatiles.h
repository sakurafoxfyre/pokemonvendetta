...
const u16 gMetatiles_Hauntwoods[] = INCBIN_U16("data/tilesets/secondary/hauntwoods/metatiles.bin");
const u16 gMetatileAttributes_Hauntwoods[] = INCBIN_U16("data/tilesets/secondary/hauntwoods/metatile_attributes.bin");
